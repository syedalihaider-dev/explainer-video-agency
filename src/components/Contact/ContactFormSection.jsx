        ...
        <div className="row">
          ...
          >
            <motion.h2 variants={fadeInUp} className={styles.mainHeading}>
              Interested in making an explainer video with us?
            </motion.h2>
            <motion.p variants={fadeInUp} className={styles.checkboxText}>
            ...
            >
              ...
              <div className={styles.checkboxWrapper}>
                ...
                <label htmlFor="agreement" className={styles.checkboxText}>
                  I agree to be contacted about my project and service requirements.
                </label>
              </div>
          ...
          >
            <motion.div variants={fadeInUp} className={styles.topBox}>
              <h2 className={styles.topBoxHeading}>Explainer Video Agency works with every type of company.</h2>
              <p className={styles.topBoxPara}>
                From seed stage SaaS and nonprofits to category leaders with a hundred features to hide. Whatever the size of the logo, the approach is the same: understand the product, find the one idea worth explaining, and build the film around it.
              </p>

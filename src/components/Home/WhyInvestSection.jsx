...
const accordionData = [
  {
    ...
    content: 'Landing page conversion lifts by as much as 80% when a considered explainer video carries the message above the fold.',
    hasButtons: true
  },
  {
    id: 2,
    ...
    content: 'Email campaigns that lead with an explainer consistently outperform static creative on click through.',
    hasButtons: true
  },
  {
    id: 3,
    icon: '/consumers.png',
    title: 'What 68% of Consumers Say',
    content: '68% of buyers would rather understand a product through a short film than through a page of copy.',
    hasButtons: true
  },
  {
    id: 4,
    icon: '/brand-security.png',
    title: 'Publishing Consistent Content',
    content: 'SaaS teams that place an explainer inside onboarding see users reach their first meaningful action sooner and churn later.',
    hasButtons: true
  },
  {
    id: 5,
    icon: '/linked.png',
    title: 'Videos That Generate More Shares',
    content: 'Explainer content earns more shares than any other creative format a marketing team ships.',
    hasButtons: true
  }
];
  ...
  return (
    <section className={styles.investSection}>
      <div className="container">
        ...
        >
          <h2 className={styles.mainTitle}>Brands That Invest In Professional Explainer Video Services Go Further</h2>
          <p className={styles.subText}>The evidence on explainer video is no longer ambiguous, and this is why our SaaS clients keep renewing the content calendar.</p>
        </motion.div>

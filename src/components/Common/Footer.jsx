  ...
  return (
    <footer className={styles.footerContainer}>
      ...
      >
        <div className={styles.footerGrid}>
          ...
          <div className={styles.footerCol}>
            <Link href="/" className={styles.logoLink}>
              <Image src="/logo.png" alt="Explainer Video Company" width={500} height={250} />
            </Link>
        ...
        <div className={styles.bottomBar}>
          <div className={styles.copyrightArea}>
            <p>© Copyright 2026 - Explainer Video Company.</p>
      ...
      <div className={styles.marqueeWrapper}>
        ...
        >
          <p className={styles.marqueeText}>Explainer Video Company. Explainer Video Company. Explainer Video Company. Explainer Video Company. </p>
          <p className={styles.marqueeText}>Explainer Video Company. Explainer Video Company. Explainer Video Company. Explainer Video Company. </p>
        </motion.div>
      </div>
    </footer>

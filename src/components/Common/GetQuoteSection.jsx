...
const defaultFeatures = [
  {
    ...
    text: "A written reply within 24 hours."
  ...
  },
  {
    ...
    text: "NDA signed before you share a roadmap or a screen."
  },
  {
    id: 3,
    icon: "/icons/security-box.png",
    title: "Expert Consultation",
    text: "You speak to a writer and a producer, never a call centre."
  }
];

export default function GetQuoteSection({
  features = defaultFeatures,
  heading = "Book a call with an explainer video strategist and get a cost quote today.",
}) {

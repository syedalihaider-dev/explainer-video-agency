...
export default function WhyPartnerSection() {
  return (
    <GlobalWhyPartnerSection
      heading="Why Choose Explainer Video Agencyas Your 2D Animation Service Provider?"
      description="Choosing a 2D animation company is a trust decision. You are handing over your brief, your budget, and a deadline with downstream consequences. Here is what makes Explainer Video Agencythe right choice."
      cardsData={cardsData}
      variant="gradient"
    />
  );

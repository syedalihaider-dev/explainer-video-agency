...
const testimonialsData = [
  {
    ...
    content: "We had worked with two 2D animation companies before Explainer Video Company. Both produced technically correct videos that moved zero metrics. Explainer Video Agencyspent three discovery sessions with us before writing a word. The 2D explainer video went live on our homepage and primary landing page. Within 60 days, free trial sign-up rate was up 38%, and every sales rep was sending it as a pre-call primer.",
  ...
  },
  {
    ...
    content: "Our product takes most salespeople 15 minutes to explain. After the Explainer Video Agency2D animated explainer went live, our sales team used it as a pre-call primer, and our demo-to-close time dropped measurably in the first full quarter. 87 seconds of video changed our sales cycle.",
  ...
  //   content: "The educational animations provided by Explainer Video Agencycompletely transformed how our students interact with our platform. Engagement has skyrocketed and the visual storytelling is top-notch.",
  //   image: "/testi-client-01.png"
  // },
  // {
  //   id: 5,

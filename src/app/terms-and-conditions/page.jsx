          ...
          <div className={styles.layout}>
            ...
            <article className={styles.article}>
              <section id="acceptance" className={styles.section}>
                ...
                <p>
                  By accessing or using the services provided by Explainer Video Agency("we," "our," "us"), including browsing our website or contracting us for animation/development production, you agree to be bound by these Terms and Conditions.
                </p>
                <p>
              ...
              <section id="services" className={styles.section}>
                ...
                <p>
                  Explainer Video Agencyprovides creative video animation (2D, 3D, CGI, Explainer videos) and interactive system development services.
                </p>
                <p>
              ...
              <section id="liability" className={styles.section}>
                ...
                <p>
                  To the maximum extent permitted by applicable law, Explainer Video Agencyshall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly.
                </p>
              </section>
